...
>
	...
	<div class="info">
		<div class="top">
			<h4>{project.name}</h4>
			<div class="links">
				<a href={project.url} class="live">
					<img src="images/icons/web.svg" alt="" />
				</a>
				<a href={project.source} class="source">
...
<style>
	.projects-card {
		...
		border-radius: 10px;
		box-shadow: inset 0px 3px 19px rgba(0, 0, 0, 0.25);
	...
	.projects-card:hover {
		filter: grayscale(0);
		max-height: 400px;
		box-shadow: inset 0px 3px 19px rgba(0, 0, 0, 0.125);
	}
